...
TEAK.Modules.freeShipping = {
	init: function(price){
		let tpl,
			freeShipping = '<p class="free-shipping-text" data-pricing-free-shipping>{{lang "product.shipping_free"}}</p></p>',
			freeWhiteGlove = [
		...
		tpl = ( price.without_tax > 2998 || price.custom > 2998 ) ? freeWhiteGlove : freeShipping;
